...
<template>
  <div class="name-form container pt-5">
    <div>
      <div>
        Escriviu el vostre nom i així apareixereu a la <b>“Galeria dels personatges dels Pirineus”</b>. Podreu col·leccionar els personatges aconseguits i els itineraris acabats o veure altres
        rutes que us falten!
      </div>
      ...
      <div v-if="!onLine" class="mt-1 mb-3">
        ...
        Només podreu accedir a la <b>“Galeria dels personatges del Pirineus”</b> de la fama quan tingueu dades.
      </div>
