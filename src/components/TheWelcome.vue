...
<template>
  ...
  <div class="welcome">
    Estas a punt de començar un dels itineraris SENPIR, on participaras en un seguit d'activitats, jocs o reptes durant tot el camí. 
    ...
    Al finalitzar, un cop tornis a tenir cobertura, podràs accedir al "Hall of fame" per veure el personatge que hauràs aconseguit.        
    <div class="privacy">
